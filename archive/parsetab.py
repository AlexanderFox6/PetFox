...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','PLYExampleCalc.py',68),
  ('statement -> expression','statement',1,'p_statement_expr','PLYExampleCalc.py',73),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','PLYExampleCalc.py',78),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','PLYExampleCalc.py',79),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','PLYExampleCalc.py',80),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','PLYExampleCalc.py',81),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','PLYExampleCalc.py',93),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','PLYExampleCalc.py',98),
  ('expression -> NUMBER','expression',1,'p_expression_number','PLYExampleCalc.py',103),
  ('expression -> NAME','expression',1,'p_expression_name','PLYExampleCalc.py',108),
]
