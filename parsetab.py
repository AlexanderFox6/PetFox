...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','tokens.py',68),
  ('statement -> expression','statement',1,'p_statement_expr','tokens.py',73),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','tokens.py',78),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','tokens.py',79),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','tokens.py',80),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','tokens.py',81),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','tokens.py',93),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','tokens.py',98),
  ('expression -> NUMBER','expression',1,'p_expression_number','tokens.py',103),
  ('expression -> NAME','expression',1,'p_expression_name','tokens.py',108),
]
